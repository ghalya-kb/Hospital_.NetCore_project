    ...
    public partial class ilk : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kuallanicilar", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adminler_Kuallanicilar_Id",
                        column: x => x.Id,
                        principalTable: "Kuallanicilar",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doktorlar_Kuallanicilar_Id",
                        column: x => x.Id,
                        principalTable: "Kuallanicilar",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hastalar_Kuallanicilar_Id",
                        column: x => x.Id,
                        principalTable: "Kuallanicilar",
                        principalColumn: "Id");
                });
